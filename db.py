...
# Database wrapper for device control (lightweight)
# Focus: devices, types, logs, state history
...
class DBWrapper:
    ...
    def init_tables(self):
        ...
        # Default device types (fixed ids): 1=output, 2=input, 3=virt
